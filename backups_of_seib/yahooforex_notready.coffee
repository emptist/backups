# I've just installed yql-node and I'll try it tomorrow
...
# https://query.yahooapis.com/v1/public/yql?q=select%20from%20yahoo.finance.historicaldata%20where%20symbol%20%3D%22EUR%3DX%22%20and%20startDate%3D%222014-09-11%22%20and%20endDate%3D%222016-05-10%22&format=json

env = "&env=store%3A%2F%2Fdatatables.org%2Falltableswithkeys&callback="
base = "https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20yahoo.finance.historicaldata%20where%20"
query = "symbol%20%3D%22#{EUR}%3DX%22%20and%20startDate%3D%22#{from}%22%20and%20endDate%3D%22#{end}%22&format=json"
### param:
symbol: usdjpy 之類
interval: 沒用
validRanges:
